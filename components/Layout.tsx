    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white selection:bg-blue-500/30 transition-colors duration-500 font-sans">
                            ...
                            >
                                <div className={`relative transition-all duration-300 ease-out ${active ? '-translate-y-1' : 'group-hover:text-gray-600 dark:group-hover:text-gray-300'}`}>
                                    <Icon 
                                        ...
                                        className={`transition-all duration-300 ${active ? 'drop-shadow-[0_4px_8px_rgba(59,130,246,0.3)]' : ''}`}
                                    />
                                </div>
            ...
            <footer className="section-padding bg-gray-50 dark:bg-black border-t border-black/5 dark:border-white/5 transition-colors duration-500 font-sans">
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 md:gap-12 lg:gap-16 mb-12 md:mb-20 md:mb-16 md:mb-24">
                    <div className="lg:col-span-4 text-start">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-lg md:text-xl leading-relaxed mb-10 max-w-lg font-medium">
                            منصة ناشئة تهدف إلى تمكين التجار العرب، عبر توفير أدوات وخدمات رقمية تساعدهم على بناء أعمال مستدامة وقابلة للنمو.
                        </p>
