            ...
            <section className="px-6 md:px-12 max-w-[1400px] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-24 mb-24">
                    ...
                    <div className="lg:col-span-5 space-y-12 text-start">
                        <div>
                            <div className="inline-flex items-center gap-3 bg-gray-100 dark:bg-white/5 text-blue-600 dark:text-blue-500 px-6 py-2 rounded-full text-sm font-black mb-8 border border-blue-500/10 dark:border-blue-500/20">
                                <Sparkles size={18} />
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                <div key={i} className="flex gap-6 items-center group">
                                    <div className="p-4 bg-gray-100 dark:bg-white/5 rounded-2xl group-hover:bg-blue-600/10 transition-colors border border-black/5 dark:border-white/5 shadow-sm dark:shadow-none">
                                        {item.i}
                                    </div>
                                    <div>
                        ...
                        <div className="pt-12 border-t border-black/5 dark:border-white/5">
                            <h4 className="text-gray-900 dark:text-white font-black text-xl mb-6">تابعنا على منصات التواصل</h4>
                            <div className="flex gap-6 text-gray-400 dark:text-gray-500 font-bold">
                                <span className="hover:text-blue-600 dark:hover:text-white cursor-pointer transition-colors">Twitter</span>
                                <span className="hover:text-blue-600 dark:hover:text-white cursor-pointer transition-colors">LinkedIn</span>
                                <span className="hover:text-blue-600 dark:hover:text-white cursor-pointer transition-colors">Instagram</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-7 bento-card p-10 md:p-16 relative overflow-hidden bg-gray-50 dark:bg-black border border-black/5 dark:border-white/10 shadow-xl dark:shadow-none transition-colors">
                        ...
                        <form onSubmit={handleSubmit} className="relative z-10 space-y-8 text-start">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-3">
                                    <label className="text-gray-900 dark:text-white font-black text-lg block">الموضوع</label>
                                    <input name="subject" required type="text" placeholder="مثلاً: استفسار عن أتمتة n8n" className="w-full bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl px-6 py-4 text-gray-900 dark:text-white outline-none focus:border-blue-500 transition-colors font-bold shadow-sm dark:shadow-none" />
                                </div>
                            </div>
                            <div className="space-y-3">
                            ...
                            <p className="text-center text-gray-500 dark:text-gray-500 font-bold text-sm">بالنقر على إرسال، سيتم توجيهك مباشرة لفتح تطبيق واتساب لبدء المحادثة.</p>
                        </form>
                    </div>
                </div>
            </section>
