            ...
            <section className="px-6 md:px-12 max-w-[1400px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mb-16 md:mb-24 text-start">
                    {[
                        ...
                        <div key={i} className="bento-card p-6 md:p-10 hover:border-black/10 dark:hover:border-white/20 transition-all bg-gray-50 dark:bg-[#151516]">
                ...
                {/* Story/Methodology */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 md:gap-12 lg:gap-16 items-center mb-16 md:mb-32">
                    <div className="space-y-8 text-start">
                        ...
                        <h2 className="text-3xl md:text-4xl lg:text-4xl md:text-6xl font-black text-gray-900 dark:text-white leading-tight tracking-tighter">لماذا "التاجر الرقمي"؟</h2>
                ...
                <div className="bento-card p-12 md:p-20 text-center bg-gray-50 dark:bg-[#0c0c0d] border border-black/5 dark:border-white/5 relative overflow-hidden transition-colors mb-16 md:mb-24">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl md:text-3xl md:text-5xl font-black text-gray-900 dark:text-white mb-8 tracking-tighter">فريقنا هو سر قوتك</h3>
                ...
                {/* Careers Section */}
                <div id="careers" className="scroll-mt-20 md:mt-16 md:mt-32">
                    <SectionHeader
                        tag="التوظيف"
                    ...
                    {/* Application Form */}
                    <div className="max-w-2xl mx-auto bg-gray-50 dark:bg-[#0c0c0d] p-8 md:p-6 md:p-12 rounded-3xl border border-black/5 dark:border-white/5">
