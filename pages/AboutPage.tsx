            ...
            <section className="px-6 md:px-12 max-w-[1400px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24 text-start">
                    {[
                        ...
                        <div key={i} className="bento-card p-10 hover:border-white/20 transition-all">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
                    <div className="space-y-8 text-start">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-white leading-tight tracking-tighter">لماذا "التاجر الرقمي"؟</h2>
                        <div className="space-y-6 text-xl text-gray-500 font-medium leading-relaxed">
                            ...
                            <p>جئنا لنغير هذا الواقع. نحن نقدم لك "فريق نمو مدمج" يتولى عنك الجوانب التقنية (SEO، برمجيات، أتمتة) والجوانب التسويقية (إعلانات، إستراتيجيات)، لتتفرغ أنت لما تتقنه: <span className="text-white">تطوير منتجاتك وخدمة عملائك.</span></p>
                        </div>
                    </div>
                    <div className="relative group">
                        ...
                        <div className="relative bento-card p-12 md:p-20 bg-black flex items-center justify-center">
                            <div className="text-center">
                                <ShieldCheck size={100} className="text-blue-500 mb-8 mx-auto opacity-30" />
                                <div className="text-3xl font-black text-white mb-2 italic">100% Reliable</div>
                                <p className="text-gray-500 font-bold uppercase tracking-widest text-sm">التزام كامل بالجودة والمواعيد</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Team / Culture */}
                <div className="bento-card p-12 md:p-20 text-center bg-gradient-to-b from-gray-900/50 to-black border-white/5 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <Sparkles size={60} className="text-blue-500 mb-8 mx-auto" />
                        <h3 className="text-3xl md:text-5xl font-black text-white mb-8 tracking-tighter">فريقنا هو سر قوتك</h3>
                        ...
                        <div className="flex flex-wrap justify-center gap-8 text-white font-black text-xl mb-12">
                        ...
                        <Link to="/contact" className="bg-white text-black px-12 py-5 rounded-3xl font-black text-xl hover:bg-blue-600 hover:text-white transition-all shadow-2xl">
                            انضم إلينا اليوم
                        </Link>
                    </div>
                </div>
