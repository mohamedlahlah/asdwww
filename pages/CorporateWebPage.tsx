    ...
    return (
        <main className="pt-16 md:pt-24 pb-20 md:pt-32 md:pb-32 bg-white dark:bg-black transition-colors duration-500 overflow-hidden">
            <section className="px-6 md:px-12 max-w-[1400px] mx-auto">
                ...
                <SectionHeader
                    tag="مرآة القرارات"
                    title="موقع شركتك هو <span className='text-blue-600'>وجه جديتها واحترافيتها.</span>"
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
                    {[
                        ...
                        <div key={i} className="bento-card p-4 md:p-6 lg:p-8 bg-gray-50 dark:bg-[#151516] hover:border-blue-500/30 transition-all group">
                            ...
                            <h4 className="text-base md:text-xl font-black text-gray-900 dark:text-white mb-3">{item.t}</h4>
                ...
                <div className="mb-32 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 md:gap-12 lg:gap-16 items-center">
                    <div className="text-start">
                        <SectionHeader
                            tag="التحول الذهني"
                            title="نحن لا نبني صفحات... <span className='text-indigo-500'>نحن نبني منصات قرار.</span>"
                    ...
                    <div className="bento-card p-12 bg-gray-50 dark:bg-[#0c0c0d] relative overflow-hidden text-start">
                        ...
                        <div className="space-y-8 relative z-10">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <span className="text-lg md:text-2xl font-black text-gray-900 dark:text-white leading-tight">ماذا يجب أن يفهم الزائر فور دخوله؟</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="bento-card p-12 bg-gray-50 dark:bg-black border border-black/5 dark:border-white/10 relative overflow-hidden">
                            ...
                            <div className="flex flex-col lg:flex-row gap-4 md:gap-8 md:gap-12 lg:gap-16 items-center">
                                <div className="lg:w-1/2 text-start relative z-10">
                                    <SectionHeader
                                        tag="هندسة المحتوى"
                                        title="المحتوى المؤسسي <span className='text-blue-500'>ليس مجرد حشو.</span>"
                ...
                <div className="mb-32 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 md:gap-12 lg:gap-16 items-center">
                    <div className="text-start">
                        <SectionHeader
                            ...
                            title="المانح للقرار <span className='text-orange-500'>لا يملك وقتاً.</span>"
                ...
                <div className="mb-48 relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 md:gap-12 lg:gap-16 items-center">
                        <div className="text-start">
                            <SectionHeader
                                tag="تطوير مؤسسي"
                                title="الموقع يجب أن يكون مستقراً <span className='text-blue-500'>قبل أن يكون جميلاً.</span>"
                            ...
                            {[
                                {
                                    ...
                                    v: "حماية فائقة",
                                    i: (
                                        <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 md:w-12 md:h-12 text-blue-500" stroke="currentColor" strokeWidth="1.5">
                                ...
                                },
                                {
                                    ...
                                    v: "تصميم متجاوب",
                                    i: (
                                        <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 md:w-12 md:h-12 text-emerald-500" stroke="currentColor" strokeWidth="1.5">
                                ...
                                },
                                {
                                    ...
                                    v: "روابط دلالية",
                                    i: (
                                        <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 md:w-12 md:h-12 text-indigo-500" stroke="currentColor" strokeWidth="1.5">
                                ...
                                },
                                {
                                    ...
                                    v: "نظام مرن",
                                    i: (
                                        <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 md:w-12 md:h-12 text-purple-500" stroke="currentColor" strokeWidth="1.5">
                                ...
                                <div key={i} className={`bento-card p-10 bg-white/50 dark:bg-[#0c0c0d] border border-black/5 dark:border-white/10 text-center flex flex-col items-center gap-6 group hover:-translate-y-2 transition-all duration-500 ${stat.glow}`}>
                                    ...
                                    <div>
                                        <div className="text-lg md:text-2xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">{stat.v}</div>
                ...
                <div className="mb-32 text-center relative">
                    ...
                    <SectionHeader
                        tag="سيو مؤسسي"
                        title="الظهور في البحث <span className='text-blue-500'>يعكس قوة الشركة.</span>"
                    ...
                    <div className="lg:col-span-12">
                        <div className="bento-card p-12 bg-purple-600/5 text-start border-purple-500/10 flex flex-col lg:flex-row gap-12 items-center">
                            <div className="lg:w-1/2">
                                <SectionHeader
                                    tag="التكامل الذكي"
                                    title="الموقع جزء من <span className='text-purple-500'>نظامك الإداري.</span>"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-start">
                        <div>
                            <SectionHeader
                                ...
                                title="الموقع ليس مشروعاً منتهياً... <span className='text-green-500'>بل كائن يتطور.</span>"
